...
public final class ListPhrase {
     ...
     */
    public static ListPhrase from(CharSequence separator) {
     ...
     */
    public static ListPhrase from(CharSequence twoElementSeparator,
    ...
    private ListPhrase(CharSequence twoElementSeparator,
                       CharSequence nonFinalElementSeparator, CharSequence finalElementSeparator) {
     ...
     */
    public <T> CharSequence join(T first, T second, T... rest) {
     ...
     * @throws IllegalArgumentException if any of the list elements are null or empty strings.
     */
    public <T> CharSequence join(Iterable<T> items) {
     ...
     * @throws IllegalArgumentException if any of the list elements are null or empty strings.
     */
    public <T> CharSequence join(Iterable<T> items, Formatter<T> formatter) {
        checkNotNullOrEmpty(items);
